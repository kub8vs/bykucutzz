...
import heroImage from "../assets/hero-shop.jpg"; // Używamy tego samego zdjęcia co w tle

const BookingSection = () => {
  return (
    <section className="relative py-32 bg-black text-white overflow-hidden">
      {/* 1. ZDJĘCIE W TLE (Styl Ekipy) */}
      <div className="absolute inset-0 z-0">
        ...
        />
        {/* Mocny gradient dla czytelności tekstu */}
        <div className="absolute inset-0 bg-gradient-to-b from-black via-black/80 to-black hero-overlay"></div>
      </div>

      {/* 2. TEKSTURA MARMURU */}
      <div className="absolute inset-0 z-[1] marble-veins opacity-40"></div>

      <div className="container mx-auto px-4 max-w-4xl relative z-10 text-center">
        {/* Ikona z animacją pulsu */}
        <motion.div 
