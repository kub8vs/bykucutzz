...
import { Scissors, ArrowRight, Star, Clock, ShieldCheck } from 'lucide-react';

const BookingSection = () => {
  return (
    <section id="rezerwacja" className="py-32 bg-black text-white relative overflow-hidden">
      {/* Efekt świetlny w tle dla klimatu premium */}
      ...
      <div className="container mx-auto px-4 max-w-4xl relative z-10 text-center">
        ...
        <div className="space-y-6 mb-12">
          ...
          <p className="text-white/40 uppercase tracking-[0.5em] text-[10px] md:text-xs font-black max-w-md mx-auto leading-relaxed">
            REZERWACJA ONLINE 24/7 PRZEZ OFICJALNY SYSTEM BOOKSY
          </p>
        </div>

        {/* GŁÓWNY PRZYCISK BOOKSY */}
        <div className="flex justify-center flex-col items-center gap-6">
          ...
          <div className="flex items-center gap-8 mt-12 text-white/30 uppercase text-[9px] font-bold tracking-[0.2em]">
            ...
            <span className="flex items-center gap-2"><Star size={14} className="text-primary" /> Najlepsze oceny</span>
            <span className="flex items-center gap-2"><ShieldCheck size={14} className="text-primary" /> Pewna rezerwacja</span>
          </div>
        </div>
      </div>
    </section>
